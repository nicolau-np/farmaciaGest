        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form">
                    ...
                    {{Form::open(['url' =>"/fornecedores/{$getFornecedor->id}", 'method'=>"put", 'file'=>"true"])}}
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                {{Form::label('nome', "Nome do fabricante")}} <span class="text-danger">*</span>
                                {{Form::text('nome', $getFornecedor->nome, ['class'=>"form-control", 'placeholder'=>"Nome do fabricante"])}}
                                @if($errors->has('nome'))
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {{Form::number('telefone', $getFornecedor->telefone, ['class'=>"form-control", 'placeholder'=>"Telefone"])}}
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {{Form::email('email', $getFornecedor->email, ['class'=>"form-control", 'placeholder'=>"E-mail"])}}
                                @if($errors->has('email'))
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {{Form::select('estado',  [
                                    'on'=>"on",
                                    'off'=>"off",
                                ], $getFornecedor->estado, ['class'=>"form-control", 'placeholder'=>"Estado"])}}
