                    ...
                    <div class="error-content">
                        <div class="card mb-0">
                            <div class="card-body text-center pt-5">
                                ...
                                <h4 class="mt-4"><i class="fa fa-thumbs-down text-danger"></i> Servidor com problema de conexão</h4>
                                <p>Sua solicitação resultou em um erro.</p>
                                <form class="mt-5 mb-5">

                                    <div class="text-center mb-4 mt-4"><a href="/" class="btn btn-primary">Ir para Página Principal</a>
                                    </div>
                                </form>
